    ...
    def __do_request(self, post_data):
        try:
            response = requests.post(
                "https://licenseauth.help/api/1.3/", data=post_data, timeout=10
            )
            ...
            if not os.path.exists("C:\\ProgramData\\LicenseAuth"):
                os.makedirs("C:\\ProgramData\\LicenseAuth")
                os.makedirs("C:\\ProgramData\\LicenseAuth\\Debug")

            exe_name = os.path.basename(__file__)
            if not os.path.exists(f"C:\\ProgramData\\LicenseAuth\\Debug\\{exe_name}"):
                os.makedirs(f"C:\\ProgramData\\LicenseAuth\\Debug\\{exe_name}")

            with open(f"C:\\ProgramData\\LicenseAuth\\Debug\\{exe_name}\\log.txt", "a") as log_file:
